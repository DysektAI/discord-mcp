...
function applyToolMetadata(tool: Record<string, any>): Record<string, any> {
...
const getAllTools = () => {
  const tools = [
    ...
    },
    {
      ...
      description:
        "Delete specific messages by ID (does not auto-select messages)",
      inputSchema: {
        type: "object",
        properties: {
          channelId: {
  ...
  try {
    ...
    switch (name) {
      ...
      case "comprehensive_channel_management": {
        ...
        const result = await discordService.comprehensiveChannelManagement(
          parsed.guildId,
          parsed.operations,
        );
        return { content: [{ type: "text", text: result }] };
    ...
    logHttp(`tool_call_error ${errorMessage}`);
    return {
              ...
              if (message.method === "initialize") {
                ...
                try {
                  ...
                  switch (name) {
                    ...
                    case "get_server_info": {
                      const parsed = schemas.ServerInfoSchema.parse(args);
                      result = await discordService.getServerInfo(
                        parsed.guildId,
                      );
                      break;
                    }
                    ...
                    case "edit_message": {
                      const parsed = schemas.EditMessageSchema.parse(args);
                      result = await discordService.editMessage(
                        parsed.channelId,
                        parsed.messageId,
                        parsed.newMessage,
                      );
                    ...
                    case "delete_message": {
                      const parsed = schemas.DeleteMessageSchema.parse(args);
                      result = await discordService.deleteMessage(
                        parsed.channelId,
                        parsed.messageId,
                      );
                      break;
                    ...
                    case "read_messages": {
                      const parsed = schemas.ReadMessagesSchema.parse(args);
                      result = await discordService.readMessages(
                        parsed.channelId,
                        parsed.count,
                      );
                      break;
                    ...
                    case "get_user_id_by_name": {
                      const parsed = schemas.GetUserIdByNameSchema.parse(args);
                      result = await discordService.getUserIdByName(
                        parsed.username,
                        parsed.guildId,
                      );
                      break;
                    ...
                    case "send_private_message": {
                      const parsed =
                        schemas.SendPrivateMessageSchema.parse(args);
                      result = await discordService.sendPrivateMessage(
                        parsed.userId,
                        parsed.message,
                      );
                      break;
                    ...
                    case "edit_private_message": {
                      const parsed =
                        schemas.EditPrivateMessageSchema.parse(args);
                      result = await discordService.editPrivateMessage(
                        parsed.userId,
                        parsed.messageId,
                        parsed.newMessage,
                      );
                    ...
                    case "delete_private_message": {
                      const parsed =
                        schemas.DeletePrivateMessageSchema.parse(args);
                      result = await discordService.deletePrivateMessage(
                        parsed.userId,
                        parsed.messageId,
                      );
                      break;
                    ...
                    case "read_private_messages": {
                      const parsed =
                        schemas.ReadPrivateMessagesSchema.parse(args);
                      result = await discordService.readPrivateMessages(
                        parsed.userId,
                        parsed.count,
                      );
                      break;
                    ...
                    case "add_reaction": {
                      const parsed = schemas.AddReactionSchema.parse(args);
                      result = await discordService.addReaction(
                        parsed.channelId,
                        parsed.messageId,
                        parsed.emoji,
                      );
                    ...
                    case "remove_reaction": {
                      const parsed = schemas.RemoveReactionSchema.parse(args);
                      result = await discordService.removeReaction(
                        parsed.channelId,
                        parsed.messageId,
                        parsed.emoji,
                      );
                    ...
                    case "create_text_channel": {
                      const parsed =
                        schemas.CreateTextChannelSchema.parse(args);
                      result = await discordService.createTextChannel(
                        parsed.guildId,
                        parsed.name,
                        parsed.categoryId,
                      );
                    ...
                    case "create_voice_channel": {
                      const parsed =
                        schemas.CreateVoiceChannelSchema.parse(args);
                      result = await discordService.createVoiceChannel(
                        parsed.guildId,
                        parsed.name,
                        parsed.categoryId,
                        parsed.userLimit,
                    ...
                    case "create_forum_channel": {
                      const parsed =
                        schemas.CreateForumChannelSchema.parse(args);
                      result = await discordService.createForumChannel(
                        parsed.guildId,
                        parsed.name,
                        parsed.categoryId,
                        {
                    ...
                    case "create_announcement_channel": {
                      ...
                      result = await discordService.createAnnouncementChannel(
                        parsed.guildId,
                        parsed.name,
                        parsed.categoryId,
                        {
                    ...
                    case "create_stage_channel": {
                      const parsed =
                        schemas.CreateStageChannelSchema.parse(args);
                      result = await discordService.createStageChannel(
                        parsed.guildId,
                        parsed.name,
                        parsed.categoryId,
                        {
                    ...
                    case "edit_channel_advanced": {
                      const parsed =
                        schemas.EditChannelAdvancedSchema.parse(args);
                      result = await discordService.editChannelAdvanced(
                        parsed.guildId,
                        parsed.channelId,
                        {
                          name: parsed.name,
                    ...
                    case "set_channel_private": {
                      const parsed =
                        schemas.SetChannelPrivateSchema.parse(args);
                      result = await discordService.setChannelPrivate(
                        parsed.guildId,
                        parsed.channelId,
                        {
                          isPrivate: parsed.isPrivate,
                    ...
                    case "set_category_private": {
                      const parsed =
                        schemas.SetCategoryPrivateSchema.parse(args);
                      result = await discordService.setCategoryPrivate(
                        parsed.guildId,
                        parsed.categoryId,
                        {
                          isPrivate: parsed.isPrivate,
                    ...
                    case "bulk_set_privacy": {
                      const parsed = schemas.BulkSetPrivacySchema.parse(args);
                      result = await discordService.bulkSetPrivacy(
                        parsed.guildId,
                        parsed.targets,
                      );
                      break;
                    ...
                    case "delete_channel": {
                      const parsed = schemas.DeleteChannelSchema.parse(args);
                      result = await discordService.deleteChannel(
                        parsed.guildId,
                        parsed.channelId,
                      );
                      break;
                    ...
                    case "find_channel": {
                      const parsed = schemas.FindChannelSchema.parse(args);
                      result = await discordService.findChannel(
                        parsed.guildId,
                        parsed.channelName,
                      );
                      break;
                    ...
                    case "list_channels": {
                      const parsed = schemas.ListChannelsSchema.parse(args);
                      result = await discordService.listChannels(
                        parsed.guildId,
                      );
                      break;
                    }
                    ...
                    case "create_category": {
                      const parsed = schemas.CreateCategorySchema.parse(args);
                      result = await discordService.createCategory(
                        parsed.guildId,
                        parsed.name,
                      );
                      break;
                    ...
                    case "delete_category": {
                      const parsed = schemas.DeleteCategorySchema.parse(args);
                      result = await discordService.deleteCategory(
                        parsed.guildId,
                        parsed.categoryId,
                      );
                      break;
                    ...
                    case "find_category": {
                      const parsed = schemas.FindCategorySchema.parse(args);
                      result = await discordService.findCategory(
                        parsed.guildId,
                        parsed.categoryName,
                      );
                      break;
                    ...
                    case "list_channels_in_category": {
                      const parsed =
                        schemas.ListChannelsInCategorySchema.parse(args);
                      result = await discordService.listChannelsInCategory(
                        parsed.guildId,
                        parsed.categoryId,
                      );
                      break;
                    ...
                    case "create_webhook": {
                      const parsed = schemas.CreateWebhookSchema.parse(args);
                      result = await discordService.createWebhook(
                        parsed.channelId,
                        parsed.name,
                      );
                      break;
                    ...
                    case "delete_webhook": {
                      const parsed = schemas.DeleteWebhookSchema.parse(args);
                      result = await discordService.deleteWebhook(
                        parsed.webhookId,
                      );
                      break;
                    }
                    case "list_webhooks": {
                      const parsed = schemas.ListWebhooksSchema.parse(args);
                      result = await discordService.listWebhooks(
                        parsed.channelId,
                      );
                      break;
                    }
                    case "send_webhook_message": {
                      const parsed =
                        schemas.SendWebhookMessageSchema.parse(args);
                      result = await discordService.sendWebhookMessage(
                        parsed.webhookUrl,
                        parsed.message,
                      );
                      break;
                    ...
                    case "join_voice_channel": {
                      const parsed = schemas.JoinVoiceChannelSchema.parse(args);
                      result = await discordService.joinVoiceChannel(
                        parsed.guildId,
                        parsed.channelId,
                      );
                      break;
                    ...
                    case "leave_voice_channel": {
                      const parsed =
                        schemas.LeaveVoiceChannelSchema.parse(args);
                      result = await discordService.leaveVoiceChannel(
                        parsed.guildId,
                        parsed.channelId,
                      );
                      break;
                    ...
                    case "play_audio": {
                      const parsed = schemas.PlayAudioSchema.parse(args);
                      result = await discordService.playAudio(
                        parsed.guildId,
                        parsed.audioUrl,
                      );
                      break;
                    ...
                    case "set_volume": {
                      const parsed = schemas.SetVolumeSchema.parse(args);
                      result = await discordService.setVolume(
                        parsed.guildId,
                        parsed.volume,
                      );
                      break;
                    ...
                    case "create_role": {
                      const parsed = schemas.CreateRoleSchema.parse(args);
                      result = await discordService.createRole(
                        parsed.guildId,
                        parsed.name,
                        parsed.color,
                        parsed.permissions,
                    ...
                    case "delete_role": {
                      const parsed = schemas.DeleteRoleSchema.parse(args);
                      result = await discordService.deleteRole(
                        parsed.guildId,
                        parsed.roleId,
                      );
                      break;
                    ...
                    case "edit_role": {
                      const parsed = schemas.EditRoleSchema.parse(args);
                      result = await discordService.editRole(
                        parsed.guildId,
                        parsed.roleId,
                        parsed.name,
                        parsed.color,
                    ...
                    case "add_role_to_member": {
                      const parsed = schemas.AddRoleToMemberSchema.parse(args);
                      result = await discordService.addRoleToMember(
                        parsed.guildId,
                        parsed.userId,
                        parsed.roleId,
                      );
                    ...
                    case "remove_role_from_member": {
                      const parsed =
                        schemas.RemoveRoleFromMemberSchema.parse(args);
                      result = await discordService.removeRoleFromMember(
                        parsed.guildId,
                        parsed.userId,
                        parsed.roleId,
                      );
                    ...
                    case "set_role_positions": {
                      const parsed = schemas.SetRolePositionsSchema.parse(args);
                      result = await discordService.setRolePositions(
                        parsed.guildId,
                        parsed.rolePositions,
                      );
                      break;
                    ...
                    case "set_channel_position": {
                      const parsed =
                        schemas.SetChannelPositionSchema.parse(args);
                      result = await discordService.setChannelPosition(
                        parsed.guildId,
                        parsed.channelId,
                        parsed.position,
                      );
                    ...
                    case "set_channel_positions": {
                      const parsed =
                        schemas.SetChannelPositionsSchema.parse(args);
                      result = await discordService.setChannelPositions(
                        parsed.guildId,
                        parsed.channelPositions,
                      );
                      break;
                    ...
                    case "move_channel_to_category": {
                      const parsed =
                        schemas.MoveChannelToCategorySchema.parse(args);
                      result = await discordService.moveChannelToCategory(
                        parsed.guildId,
                        parsed.channelId,
                        parsed.categoryId,
                      );
                    ...
                    case "set_category_position": {
                      const parsed =
                        schemas.SetCategoryPositionSchema.parse(args);
                      result = await discordService.setCategoryPosition(
                        parsed.guildId,
                        parsed.categoryId,
                        parsed.position,
                      );
                    ...
                    case "organize_channels": {
                      const parsed = schemas.OrganizeChannelsSchema.parse(args);
                      result = await discordService.organizeChannels(
                        parsed.guildId,
                        parsed.organization,
                      );
                      break;
                    ...
                    case "get_channel_structure": {
                      const parsed =
                        schemas.GetChannelStructureSchema.parse(args);
                      result = await discordService.getChannelStructure(
                        parsed.guildId,
                      );
                      break;
                    }
                    ...
                    case "pin_message": {
                      const parsed = schemas.PinMessageSchema.parse(args);
                      result = await discordService.pinMessage(
                        parsed.channelId,
                        parsed.messageId,
                      );
                      break;
                    ...
                    case "unpin_message": {
                      const parsed = schemas.UnpinMessageSchema.parse(args);
                      result = await discordService.unpinMessage(
                        parsed.channelId,
                        parsed.messageId,
                      );
                      break;
                    ...
                    case "get_pinned_messages": {
                      const parsed =
                        schemas.GetPinnedMessagesSchema.parse(args);
                      result = await discordService.getPinnedMessages(
                        parsed.channelId,
                      );
                      break;
                    }
                    case "bulk_delete_messages": {
                      const parsed =
                        schemas.BulkDeleteMessagesSchema.parse(args);
                      result = await discordService.bulkDeleteMessages(
                        parsed.channelId,
                        parsed.messageIds,
                        parsed.filterOld,
                      );
                    ...
                    case "crosspost_message": {
                      const parsed = schemas.CrosspostMessageSchema.parse(args);
                      result = await discordService.crosspostMessage(
                        parsed.channelId,
                        parsed.messageId,
                      );
                      break;
                    ...
                    case "get_members": {
                      const parsed = schemas.GetMembersSchema.parse(args);
                      result = await discordService.getMembers(
                        parsed.guildId,
                        parsed.limit,
                        parsed.after,
                      );
                    ...
                    case "search_members": {
                      const parsed = schemas.SearchMembersSchema.parse(args);
                      result = await discordService.searchMembers(
                        parsed.guildId,
                        parsed.query,
                        parsed.limit,
                      );
                    ...
                    case "edit_member": {
                      const parsed = schemas.EditMemberSchema.parse(args);
                      result = await discordService.editMember(
                        parsed.guildId,
                        parsed.userId,
                        parsed.nickname,
                        parsed.roles,
                    ...
                    case "get_member_info": {
                      const parsed = schemas.GetMemberInfoSchema.parse(args);
                      result = await discordService.getMemberInfo(
                        parsed.guildId,
                        parsed.userId,
                      );
                      break;
                    ...
                    case "create_event": {
                      const parsed = schemas.CreateEventSchema.parse(args);
                      result = await discordService.createEvent(
                        parsed.guildId,
                        parsed.name,
                        parsed.description,
                        parsed.startTime,
                    ...
                    case "edit_event": {
                      const parsed = schemas.EditEventSchema.parse(args);
                      result = await discordService.editEvent(
                        parsed.guildId,
                        parsed.eventId,
                        parsed.name,
                        parsed.description,
                    ...
                    case "delete_event": {
                      const parsed = schemas.DeleteEventSchema.parse(args);
                      result = await discordService.deleteEvent(
                        parsed.guildId,
                        parsed.eventId,
                      );
                      break;
                    ...
                    case "create_invite": {
                      const parsed = schemas.CreateInviteSchema.parse(args);
                      result = await discordService.createInvite(
                        parsed.channelId,
                        parsed.maxAge,
                        parsed.maxUses,
                        parsed.temporary,
                    ...
                    case "delete_invite": {
                      const parsed = schemas.DeleteInviteSchema.parse(args);
                      result = await discordService.deleteInvite(
                        parsed.inviteCode,
                      );
                      break;
                    }
                    ...
                    case "create_emoji": {
                      const parsed = schemas.CreateEmojiSchema.parse(args);
                      result = await discordService.createEmoji(
                        parsed.guildId,
                        parsed.name,
                        parsed.imageUrl,
                        parsed.roles,
                    ...
                    case "delete_emoji": {
                      const parsed = schemas.DeleteEmojiSchema.parse(args);
                      result = await discordService.deleteEmoji(
                        parsed.guildId,
                        parsed.emojiId,
                      );
                      break;
                    ...
                    case "create_sticker": {
                      const parsed = schemas.CreateStickerSchema.parse(args);
                      result = await discordService.createSticker(
                        parsed.guildId,
                        parsed.name,
                        parsed.description,
                        parsed.tags,
                    ...
                    case "delete_sticker": {
                      const parsed = schemas.DeleteStickerSchema.parse(args);
                      result = await discordService.deleteSticker(
                        parsed.guildId,
                        parsed.stickerId,
                      );
                      break;
                    ...
                    case "get_message_attachments": {
                      const parsed =
                        schemas.GetMessageAttachmentsSchema.parse(args);
                      result = await discordService.getMessageAttachments(
                        parsed.channelId,
                        parsed.messageId,
                      );
                      break;
                    ...
                    case "create_automod_rule": {
                      const parsed =
                        schemas.CreateAutomodRuleSchema.parse(args);
                      result = await discordService.createAutomodRule(
                        parsed.guildId,
                        parsed.name,
                        parsed.eventType,
                        parsed.triggerType,
                    ...
                    case "edit_automod_rule": {
                      const parsed = schemas.EditAutomodRuleSchema.parse(args);
                      result = await discordService.editAutomodRule(
                        parsed.guildId,
                        parsed.ruleId,
                        parsed.name,
                        parsed.enabled,
                    ...
                    case "delete_automod_rule": {
                      const parsed =
                        schemas.DeleteAutomodRuleSchema.parse(args);
                      result = await discordService.deleteAutomodRule(
                        parsed.guildId,
                        parsed.ruleId,
                      );
                      break;
                    ...
                    case "get_automod_rules": {
                      const parsed = schemas.GetAutomodRulesSchema.parse(args);
                      result = await discordService.getAutomodRules(
                        parsed.guildId,
                      );
                      break;
                    }
                    ...
                    case "send_modal": {
                      const parsed = schemas.SendModalSchema.parse(args);
                      result = await discordService.sendModal(
                        parsed.interactionId,
                        parsed.title,
                        parsed.customId,
                        parsed.components,
                    ...
                    case "send_button": {
                      const parsed = schemas.SendButtonSchema.parse(args);
                      result = await discordService.sendButton(
                        parsed.channelId,
                        parsed.content,
                        parsed.buttons,
                      );
                    ...
                    case "send_select_menu": {
                      const parsed = schemas.SendSelectMenuSchema.parse(args);
                      result = await discordService.sendSelectMenu(
                        parsed.channelId,
                        parsed.content,
                        parsed.customId,
                        parsed.placeholder,
                    ...
                    case "edit_server": {
                      const parsed = schemas.EditServerSchema.parse(args);
                      result = await discordService.editServer(
                        parsed.guildId,
                        parsed.name,
                        parsed.description,
                        parsed.icon,
                    ...
                    case "get_server_widget": {
                      const parsed = schemas.GetServerWidgetSchema.parse(args);
                      result = await discordService.getServerWidget(
                        parsed.guildId,
                      );
                      break;
                    }
                    case "get_welcome_screen": {
                      const parsed = schemas.GetWelcomeScreenSchema.parse(args);
                      result = await discordService.getWelcomeScreen(
                        parsed.guildId,
                      );
                      break;
                    }
                    case "edit_welcome_screen": {
                      const parsed =
                        schemas.EditWelcomeScreenSchema.parse(args);
                      result = await discordService.editWelcomeScreen(
                        parsed.guildId,
                        parsed.enabled,
                        parsed.description,
                        parsed.welcomeChannels,
                    ...
                    case "get_message_history": {
                      const parsed =
                        schemas.GetMessageHistorySchema.parse(args);
                      result = await discordService.getMessageHistory(
                        parsed.channelId,
                        parsed.limit,
                        parsed.before,
                        parsed.after,
                    ...
                    case "get_server_stats": {
                      const parsed = schemas.GetServerStatsSchema.parse(args);
                      result = await discordService.getServerStats(
                        parsed.guildId,
                      );
                      break;
                    }
                    case "export_chat_log": {
                      const parsed = schemas.ExportChatLogSchema.parse(args);
                      result = await discordService.exportChatLog(
                        parsed.channelId,
                        parsed.format,
                        parsed.limit,
                        parsed.dateRange,
