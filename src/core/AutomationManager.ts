...
export class AutomationManager {
  ...
  async replyMessage(
    ...
    const parsed = schemas.ReplyMessageSchema.parse({
      channelId,
      messageId,
      message,
    });
    return await this.discordService.replyMessage(
      parsed.channelId,
      parsed.messageId,
      parsed.message,
    );
  ...
  async leaveVoiceChannel(guildId: string): Promise<string> {
    const parsed = schemas.LeaveVoiceChannelSchema.parse({ guildId });
  ...
  async sendModal(
    ...
    const parsed = schemas.SendModalSchema.parse({
      interactionId,
      title,
      customId,
      components,
    });
    return await this.discordService.sendModal(
